...
//입력된 값을 통해 레이어를 설정한다.	
HRESULT cUILayer::SetLayer(IN string strLayerName, IN Vector3 vPosition, IN ST_SIZE stLayerSize,
    IN bool useBackground, IN Color colorBackGround, IN string strTextureName)
{
    HRESULT hr;
