...
void cShop::SetShopUI()
{
    ...
    string szPath = INTERFACE_PATH + (string)"shop-bg.png";
    ...
    pShopNameText->SetFont(g_pFontManager->GetFont(g_pFontManager->E_SHOP));
    pShopNameText->SetText("Shop");
    ...
    //szPath = INTERFACE_PATH + (string)"button/x-button-normal.png";
    //g_pTextureManager->AddTexture("x-normal-btn", szPath, true);
    ...
    pBuyText->SetFont(g_pFontManager->GetFont(g_pFontManager->E_SHOP));
    pBuyText->SetText("구 입");
    ...
    pMoneyText->SetFont(g_pFontManager->GetFont(g_pFontManager->E_SHOP));
    char szMoney[20];
...
void cShop::SetShopItemUI(Vector3 vShopPos)
{
    ...
    for (int i = 0; i < m_vecItemInfo.size(); ++i)
    {
        ...
        //szPath = INTERFACE_PATH + (string)"button/button-select.png";
        //g_pTextureManager->AddTexture("select-btn", szPath, true);
        //pSelectButton->SetTexture("normal-btn", "mouse-over-btn", "select-btn");

        pSelectButton->SetSize(Vector2(stItemSize.w + stItemContentsSize.w + fPlusX, stItemSize.h));
        ...
        pNameText->SetFont(g_pFontManager->GetFont(g_pFontManager->E_SHOP));
        ...
        pPlusValueText->SetFont(g_pFontManager->GetFont(g_pFontManager->E_SHOP));
        char buf[10];
        sprintf_s(buf, sizeof(buf), "%d +%d", m_vecItemInfo[i].nPlusStat, (int)m_vecItemInfo[i].fPlusValue);
        ...
        pPriceText->SetFont(g_pFontManager->GetFont(g_pFontManager->E_SHOP));
